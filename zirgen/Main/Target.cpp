...
llvm::StringRef WgslCodegenTarget::getDeclExtension() const {
  return "wgsl";
}
llvm::StringRef WgslCodegenTarget::getImplExtension() const {
  return "wgsl";
}

Template WgslCodegenTarget::getStepTemplate() const {
  // WGSL has no namespaces, no #include, no preprocessor. The field-arithmetic
  // prelude (BabyBear add/sub/mul over u32, matching risc0's
  // webgpu_codegen/prelude.wgsl) and the storage/uniform bindings are wired in
  // a later iteration; this iteration proves the codegen toolchain end-to-end.
  return Template{.header = (licenseHeader + R"(
// AUTO-GENERATED by zirgen WGSL backend. Do not edit.
)")
                                .str(),
                  .footer = ""};
}
